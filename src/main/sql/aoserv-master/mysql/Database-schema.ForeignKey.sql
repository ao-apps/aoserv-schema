...
select "schema".add_foreign_key('mysql', 'mysql_databases', 'mysql_server',     'mysql',   'mysql_servers',     'bind',   '1.81.18', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('mysql', 'mysql_databases', 'mysql_server',     'mysql',   'mysql_servers',     'bind',   '1.92.2.4-SNAPSHOT', null);
