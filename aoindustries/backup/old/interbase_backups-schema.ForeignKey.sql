select "schema".add_foreign_key('backup', 'interbase_backups', 'package',          'public', 'packages',          'pkey',   '1.0a100', '1.30');
select "schema".add_foreign_key('backup', 'interbase_backups', 'ao_server',        'public', 'ao_servers',        'server', '1.0a100', '1.30');
