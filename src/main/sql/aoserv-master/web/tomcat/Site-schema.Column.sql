...
select "schema".add_column('web.tomcat', 'httpd_tomcat_sites', 'httpd_site',   'fkey',    false,  true, false, 'the site that this Tomcat is running in', '1.0a100', '1.92.2.3-SNAPSHOT');
select "schema".add_column('web.tomcat', 'httpd_tomcat_sites', 'httpd_site',   'pkey',    false,  true, false, 'the site that this Tomcat is running in', '1.92.2.4-SNAPSHOT', null);
