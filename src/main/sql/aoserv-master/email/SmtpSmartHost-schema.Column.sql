...
select "schema".add_column('email', 'email_smtp_smart_hosts', 'default_domain_out_rate',  'float',  true, false, false, 'the default per-domain email rate when no domain-specific value is provided in email_smtp_smart_host_domains, null means unlimited', '1.57', null);
