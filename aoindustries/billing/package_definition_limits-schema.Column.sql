...
select "schema".add_column('billing', 'package_definition_limits', 'additional_rate',             'decimal_2', true, false, false, 'the monthly rate for those past the soft_limit', '1.0a123', null);
