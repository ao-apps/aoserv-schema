...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'smtp_password', 6, 'string', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'imap_linux_server_account', 7, 'fkey', false, true, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'imap_password', 8, 'string', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_email_address', 9, 'fkey', false, true, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_email_display', 10, 'string', false, true, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'signup_email_address', 11, 'fkey', false, true, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'signup_email_display', 12, 'string', false, true, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'ticket_encryption_from', 13, 'fkey', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'ticket_encryption_recipient', 14, 'fkey', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'signup_encryption_from', 15, 'fkey', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'signup_encryption_recipient', 16, 'fkey', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_toll_free', 17, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_day_phone', 18, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_emergency_phone1', 19, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_emergency_phone2', 20, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_fax', 21, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_mailing_address1', 22, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_mailing_address2', 23, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_mailing_address3', 24, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'support_mailing_address4', 25, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'english_enabled', 26, 'boolean', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'japanese_enabled', 27, 'boolean', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'aoweb_struts_http_url_base', 28, 'string', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'aoweb_struts_https_url_base', 29, 'string', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'aoweb_struts_google_verify_content', 30, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'aoweb_struts_noindex', 31, 'boolean', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'aoweb_struts_google_analytics_new_tracking_code', 32, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'brands', 'aoweb_struts_signup_admin_address', 33, 'string', false, false, false, '', '1.44', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'config_backup_level', 9, 'short', false, false, false, 'the number of copies of config backup files', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'config_backup_retention', 10, 'short', false, false, false, 'the number of days backups will be kept', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'file_backup_level', 11, 'short', false, false, false, 'the number of copies of backup files', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'file_backup_retention', 12, 'short', false, false, false, 'the number of days backups will be kept', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'ftp_backup_level', 13, 'short', false, false, false, 'the number of copies of FTP backup files', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'ftp_backup_retention', 14, 'short', false, false, false, 'the number of days backups will be kept', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'log_backup_level', 15, 'short', false, false, false, 'the number of copies of log backup files', '1.0a100', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'log_backup_retention', 16, 'short', false, false, false, 'the number of days backups will be kept', '1.0a100', '1.30';
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'brand', 2, 'accounting', false, false, false, 'the brand of the seller/reseller that supports this package', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'category', 3, 'string', false, false, false, 'the package category', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'name', 4, 'string', false, false, false, 'the name of the package', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'version', 5, 'string', false, false, false, 'the unique version of this package', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'display', 6, 'string', false, false, false, 'a short description for display use', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'description', 7, 'string', false, false, false, 'a description of the package definition', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'setup_fee', 8, 'decimal_2', true, false, false, 'the setup fee for this package definition', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'setup_fee_transaction_type', 9, 'string', true, false, false, '', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'monthly_rate', 10, 'decimal_2', true, false, false, 'the default monthly charge for this package', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'monthly_rate_transaction_type', 11, 'string', true, false, false, '', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'active', 12, 'boolean', false, false, false, 'allows new accounts for this package', '1.0a123', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'package_definitions', 'approved', 13, 'boolean', false, false, false, 'once approved a definition may be used for packages, but may not be modified', '1.0a123', null;
commit;
begin;
\echo packages
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'email_in_burst', 17, 'int', true, false, false, 'the maximum burst of inbound email before limiting begins', '1.24', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'email_in_rate', 18, 'float', true, false, false, 'the number of sustained inbound emails per second', '1.24', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'email_out_burst', 19, 'int', true, false, false, 'the maximum burst of outbound email before limiting begins', '1.24', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'email_out_rate', 20, 'float', true, false, false, 'the number of sustained outbound emails per second', '1.24', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'email_relay_burst', 21, 'int', true, false, false, 'the maximum burst of relay email before limiting begins', '1.24', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'email_relay_rate', 22, 'float', true, false, false, 'the number of sustained relay emails per second', '1.24', null;
commit;
begin;
\echo payment_types
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'reseller', 1, 'accounting', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'package', 2, 'package', false, false, false, '', '1.0a100', '1.0a125';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'accounting', 3, 'accounting', true, false, false, '', '1.0a126', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'language', 4, 'string', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'administrator', 5, 'username', false, false, false, '', '1.0a100', '1.0a125';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'created_by', 6, 'username', true, false, false, '', '1.0a126', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'category', 7, 'fkey', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'ticket_type', 8, 'string', false, false, false, '', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'from_address', 9, 'email', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'summary', 10, 'string', false, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'details', 11, 'string', false, false, false, '', '1.0a100', '1.43';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'details', 12, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'raw_email', 13, 'string', true, false, false, '', '1.44', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'open_date', 14, 'time', false, false, false, '', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'deadline', 15, 'time', true, false, false, '', '1.0a100', '1.43';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'close_date', 16, 'time', true, false, false, '', '1.0a100', '1.43';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'closed_by', 17, 'username', true, false, false, '', '1.0a100', '1.43';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'client_priority', 18, 'string', false, false, false, '', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'admin_priority', 19, 'string', false, false, false, '', '1.0a100', '1.9';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'admin_priority', 20, 'string', true, false, false, '', '1.10', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'technology', 21, 'string', true, false, false, '', '1.0a100', '1.43';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'status', 22, 'string', false, false, false, '', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'assigned_to', 23, 'string', true, false, false, '', '1.0a125', '1.43';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'contact_emails', 24, 'string', false, false, false, '', '1.0a125', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'tickets', 'contact_phone_numbers', 25, 'string', false, false, false, '', '1.0a125', null;
commit;
begin;
\echo time_zones
