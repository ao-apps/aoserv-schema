create sequence web.httpd_site_bind_redirects_pkey_seq cycle;
grant all    on web.httpd_site_bind_redirects_pkey_seq to aoadmin;
grant select on web.httpd_site_bind_redirects_pkey_seq to aoserv_app; -- , update

create table httpd_site_bind_redirects (
  pkey            integer
    default nextval('web.httpd_site_bind_redirects_pkey_seq')
    primary key,
