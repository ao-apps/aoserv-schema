...
select "schema".add_column('schema', 'schema_types', 'sinceVersion',  'string', false, false, true, 'the first aoserv_protocol version this type was in', '1.81.18', '1.92.2.2-SNAPSHOT');
select "schema".add_column('schema', 'schema_types', 'sinceVersion',  'enum'  , false, false, true, 'the first aoserv_protocol version this type was in', '1.92.2.3-SNAPSHOT', null);
...
select "schema".add_column('schema', 'schema_types', 'lastVersion',   'string',  true, false, true, 'the last version containing this type', '1.81.18', '1.92.2.2-SNAPSHOT');
select "schema".add_column('schema', 'schema_types', 'lastVersion',   'enum',    true, false, true, 'the last version containing this type', '1.92.2.3-SNAPSHOT', null);
