create sequence httpd.httpd_site_bind_redirects_pkey_seq cycle;
grant all    on httpd.httpd_site_bind_redirects_pkey_seq to aoadmin;
grant select on httpd.httpd_site_bind_redirects_pkey_seq to aoserv_app; -- , update

create table httpd_site_bind_redirects (
  pkey            integer
    default nextval('httpd.httpd_site_bind_redirects_pkey_seq')
    primary key,
