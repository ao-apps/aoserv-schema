...
select "schema".add_column('net', 'net_tcp_redirects', 'net_bind',                'fkey',     false,  true, false, 'the pkey as found in net_binds', '1.69', '1.92.2.3-SNAPSHOT');
select "schema".add_column('net', 'net_tcp_redirects', 'net_bind',                'pkey',     false,  true, false, 'the pkey as found in net_binds', '1.92.2.4-SNAPSHOT', null);
