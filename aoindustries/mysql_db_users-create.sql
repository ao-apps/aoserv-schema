...
create table mysql_db_users (
  ...
  mysql_server integer not null, -- This is not selected by the client, it is used to reference superkeys to ensure the database and user are for the same mysql_server
