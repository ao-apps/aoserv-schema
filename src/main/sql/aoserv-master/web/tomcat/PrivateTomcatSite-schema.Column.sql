...
select "schema".add_column('web.tomcat', 'httpd_tomcat_std_sites', 'max_post_size',         'int',      true, false, false, 'the maxPostSize setting for this Tomcat', '1.80.1', null);
...
select "schema".add_column('web.tomcat', 'httpd_tomcat_std_sites', 'undeployOldVersions',   'boolean', false, false, false, 'the undeployOldVersions setting for this Tomcat', '1.92.0', null);
