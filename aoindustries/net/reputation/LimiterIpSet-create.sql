/* TODO
create sequence         "net/reputation"."LimiterIpSet_pkey_seq" cycle;
grant all            on "net/reputation"."LimiterIpSet_pkey_seq" to aoadmin;
--grant select, update on "net/reputation"."LimiterIpSet_pkey_seq" to aoserv_app;
...
create table "net/reputation"."LimiterIpSet" (
  pkey integer
    default nextval('"net/reputation"."LimiterIpSet_pkey_seq"')
    primary key,
