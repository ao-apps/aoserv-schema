...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'disable_log', 'accounting', 2, 'accounting', false, false, false, 'the business whose resources are being disabled', '1.0a100', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'max_concurrency',                 16, 'int',      false, false, false, 'the maximum number of processes/threads for this server instance', '1.68', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'monitoring_concurrency_low',      17, 'int',       true, false, false, 'the concurrency that will trigger a low-level alert',      '1.81.11', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'monitoring_concurrency_medium',   18, 'int',       true, false, false, 'the concurrency that will trigger a medium-level alert',   '1.81.11', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'monitoring_concurrency_high',     19, 'int',       true, false, false, 'the concurrency that will trigger a high-level alert',     '1.81.11', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'monitoring_concurrency_critical', 20, 'int',       true, false, false, 'the concurrency that will trigger a critical-level alert', '1.81.11', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_access_compat',               21, 'boolean',   true, false, false, 'manually enables or disables the mod_access_compat Apache module for this server instance',   '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_actions',                     22, 'boolean',   true, false, false, 'manually enables or disables the mod_actions Apache module for this server instance',         '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_alias',                       23, 'boolean',   true, false, false, 'manually enables or disables the mod_alias Apache module for this server instance',           '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_auth_basic',                  24, 'boolean',   true, false, false, 'manually enables or disables the mod_auth_basic Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_authn_core',                  25, 'boolean',   true, false, false, 'manually enables or disables the mod_authn_core Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_authn_file',                  26, 'boolean',   true, false, false, 'manually enables or disables the mod_authn_file Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_authz_core',                  27, 'boolean',   true, false, false, 'manually enables or disables the mod_authz_core Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_authz_groupfile',             28, 'boolean',   true, false, false, 'manually enables or disables the mod_authz_groupfile Apache module for this server instance', '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_authz_host',                  29, 'boolean',   true, false, false, 'manually enables or disables the mod_authz_host Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_authz_user',                  30, 'boolean',   true, false, false, 'manually enables or disables the mod_authz_user Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_autoindex',                   31, 'boolean',   true, false, false, 'manually enables or disables the mod_autoindex Apache module for this server instance',       '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_deflate',                     32, 'boolean',   true, false, false, 'manually enables or disables the mod_deflate Apache module for this server instance',         '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_dir',                         33, 'boolean',   true, false, false, 'manually enables or disables the mod_dir Apache module for this server instance',             '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_filter',                      34, 'boolean',   true, false, false, 'manually enables or disables the mod_filter Apache module for this server instance',          '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_headers',                     35, 'boolean',   true, false, false, 'manually enables or disables the mod_headers Apache module for this server instance',         '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_include',                     36, 'boolean',   true, false, false, 'manually enables or disables the mod_include Apache module for this server instance',         '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_jk',                          37, 'boolean',   true, false, false, 'manually enables or disables the mod_jk Apache module for this server instance',              '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_log_config',                  38, 'boolean',   true, false, false, 'manually enables or disables the mod_log_config Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_mime',                        39, 'boolean',   true, false, false, 'manually enables or disables the mod_mime Apache module for this server instance',            '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_mime_magic',                  40, 'boolean',   true, false, false, 'manually enables or disables the mod_mime_magic Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_negotiation',                 41, 'boolean',   true, false, false, 'manually enables or disables the mod_negotiation Apache module for this server instance',     '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_proxy',                       42, 'boolean',   true, false, false, 'manually enables or disables the mod_proxy Apache module for this server instance',           '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_proxy_http',                  43, 'boolean',   true, false, false, 'manually enables or disables the mod_proxy_http Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_reqtimeout',                  44, 'boolean',   true, false, false, 'manually enables or disables the mod_reqtimeout Apache module for this server instance',      '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_rewrite',                     45, 'boolean',   true, false, false, 'manually enables or disables the mod_rewrite Apache module for this server instance',         '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_setenvif',                    46, 'boolean',   true, false, false, 'manually enables or disables the mod_setenvif Apache module for this server instance',        '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_socache_shmcb',               47, 'boolean',   true, false, false, 'manually enables or disables the mod_socache_shmcb Apache module for this server instance',   '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_ssl',                         48, 'boolean',   true, false, false, 'manually enables or disables the mod_ssl Apache module for this server instance',             '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_status',                      49, 'boolean',   true, false, false, 'manually enables or disables the mod_status Apache module for this server instance',          '1.81.7',  null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_servers', 'mod_wsgi',                        50, 'boolean',   true, false, false, 'manually enables or disables the mod_wsgi Apache module for this server instance',            '1.81.10', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_authenticated_locations', 'handler',               8, 'string',   true, false, false, 'the optional handler for this location',                                                     '1.81.13', null;
commit;
begin;
\echo httpd_site_bind_headers
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'pkey',             0, 'pkey',    false,  true, false, 'a generated primary key',                     '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'httpd_site_bind',  1, 'fkey',    false, false, false, 'the site bind that is being referenced',      '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'sort_order',       2, 'short',   false, false, false, 'the per-bind unique sort ordering',           '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'type',             3, 'string',  false, false, false, 'the type of header, either "Header" or "RequestHeader"', '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'always',           4, 'boolean', false, false, false, 'the condition is either "onsuccess" (default, can be omitted) or "always"', '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'action',           5, 'string',  false, false, false, 'the action to be performed',                  '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'header',           6, 'string',  false, false, false, 'the header name, without any final colon',    '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'value',            7, 'string',   true, false, false, 'the header value, not used for all actions',  '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'replacement',      8, 'string',   true, false, false, 'the replacement value, only used for "edit" and "edit*"', '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'when',             9, 'string',   true, false, false, 'optional control over when is this header directive is applied', '1.81.15', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_headers', 'comment',         10, 'string',   true, false, false, 'an optional comment describing the redirect', '1.81.15', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_bind_redirects', 'comment',         5, 'string',   true, false, false, 'an optional comment describing the redirect', '1.81.1', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'name',                          3, 'string',   true, false, false, 'the name of the bind, null for the default bind', '1.81.14', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'access_log',                    4, 'path',    false, false, false, 'the file used for access logging',                '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'error_log',                     5, 'path',    false, false, false, 'the file used for error logging',                 '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'certificate',                   6, 'fkey',     true, false, false, 'the certificate used by this bind',               '1.81.10', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'ssl_cert_file',                 7, 'path',     true, false, false, 'the file holding the public key (HTTPS only)',    '1.0a100', '1.81.9';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'ssl_cert_key_file',             8, 'path',     true, false, false, 'the file holding the private key (HTTPS only)',   '1.0a100', '1.81.9';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'ssl_cert_chain_file',           9, 'path',     true, false, false, 'the file holding the CA chain (HTTPS only)',      '1.81.4',  '1.81.9';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'disable_log',                  10, 'fkey',     true, false, false, 'indicates that this bind is disabled',            '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'predisable_config',            11, 'string',   true, false, false, 'the config file before the site was disabled',    '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'is_manual',                    12, 'boolean', false, false, false, 'the config file is manually maintained',          '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'redirect_to_primary_hostname', 13, 'boolean', false, false, false, 'tells that system to redirect any request that is not to either the IP address or the primary hostname to the primary hostname, while leaving the request path intact', '1.19', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_site_binds', 'include_site_config',          14, 'string',   true, false, false, 'controls whether this bind includes the per-site configuration file', '1.81.10', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'block_trace_track',       29, 'boolean',    false, false, false, 'Enables the blocking of TRACE and TRACK HTTP methods on this site.', '1.81.6', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'block_scm',               30, 'boolean',    false, false, false, 'Enables the blocking of URL patterns associated with source control management systems.', '1.81.6', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'block_core_dumps',        31, 'boolean',    false, false, false, 'Enables the blocking of core dumps.', '1.81.6', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'block_editor_backups',    32, 'boolean',    false, false, false, 'Enables the blocking filename patterns associated with editor automatic backups.', '1.81.6', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_tomcat_site_jk_mounts', 'pkey',              0, 'pkey',    false,  true, false, 'a generated primary key',               '1.81.6', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_tomcat_site_jk_mounts', 'httpd_tomcat_site', 1, 'fkey',    false, false, false, 'the Tomcat site that is being mounted', '1.81.6', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_tomcat_site_jk_mounts', 'path',              2, 'string',  false, false, false, 'the per-site unique pattern matched',   '1.81.6', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_tomcat_site_jk_mounts', 'mount',             3, 'boolean', false, false, false, 'true for JkMount, false for JkUnMount', '1.81.6', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_tomcat_sites', 'use_apache',   2, 'boolean', false, false, false, 'determines if Apache serves the static site content', '1.0a100', '1.81.5';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_tomcat_sites', 'block_webinf', 3, 'boolean', false, false, false, 'Blocks access to /META-INF and /WEB-INF at the Apache level.', '1.81.6', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'office_phone', 7, 'gecos', true, false, false, 'the work phone number of the user', '1.69', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'home_phone', 8, 'phone', true, false, false, 'the home phone number of the user', '1.0a100', '1.68';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'home_phone', 9, 'gecos', true, false, false, 'the home phone number of the user', '1.69', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'type', 10, 'string', false, false, false, 'the type of account', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'shell', 11, 'path', false, false, false, 'the users shell preference', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'created', 12, 'time', false, false, false, 'the time the account was created', '1.0a100', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_accounts', 'disable_log', 13, 'fkey', true, false, false, 'indicates that this account is disabled', '1.0a100', null;
commit;
begin;
