create sequence ssl_certificate_other_uses_pkey_seq cycle;
grant all    on ssl_certificate_other_uses_pkey_seq to aoadmin;
grant select on ssl_certificate_other_uses_pkey_seq to aoserv_app;
