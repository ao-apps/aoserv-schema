...
select "schema".add_column('accounting', 'bank_accounts', 'deposit_delay', 'int', false, false, false, 'the number of business days it takes for a deposit to be sent to the bank account', '1.0a100', null);
select "schema".add_column('accounting', 'bank_accounts', 'withdrawal_delay', 'int', false, false, false, 'the number of business days it takes for a withdrawal to be taken from the bank account', '1.0a100', null);
