...
select "schema".add_foreign_key('email', 'majordomo_lists', 'email_list',                'email', 'email_lists',          'pkey',   '1.0a100', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('email', 'majordomo_lists', 'email_list',                'email', 'email_lists',          'pkey',   '1.92.2.4-SNAPSHOT', null);
select "schema".add_foreign_key('email', 'majordomo_lists', 'majordomo_server',          'email', 'majordomo_servers',    'domain', '1.0a100', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('email', 'majordomo_lists', 'majordomo_server',          'email', 'majordomo_servers',    'domain', '1.92.2.4-SNAPSHOT', null);
