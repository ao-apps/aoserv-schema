...
select "schema".add_foreign_key('mysql', 'mysql_server_users', 'ao_server',    'public', 'ao_servers',    'server',   '1.0a100', '1.3');
select "schema".add_foreign_key('mysql', 'mysql_server_users', 'mysql_server',           'mysql_servers', 'pkey',     '1.4',     null);
select "schema".add_foreign_key('mysql', 'mysql_server_users', 'disable_log',  'public', 'disable_log',   'pkey',     '1.0a100', null);
