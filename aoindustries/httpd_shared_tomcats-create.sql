...
create table httpd_shared_tomcats (
  pkey integer default nextval('httpd_shared_tomcats_pkey_seq') primary key,
  "name" text not null,
  ao_server integer not null,
  version integer not null,
  linux_server_account integer not null,
  linux_server_group integer not null,
  disable_log integer,
  tomcat4_worker integer unique,
  tomcat4_shutdown_port integer unique,
