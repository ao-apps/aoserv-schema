...
select "schema".add_foreign_key('schema', 'schema_columns', 'sinceVersion',  'schema', 'aoserv_protocols', 'version', '1.81.18', '1.92.2.2-SNAPSHOT');
select "schema".add_foreign_key('schema', 'schema_columns', 'sinceVersion',  'schema', 'aoserv_protocols', 'version', '1.92.2.3-SNAPSHOT', null);
select "schema".add_foreign_key('schema', 'schema_columns', 'lastVersion',   'schema', 'aoserv_protocols', 'version', '1.81.18', '1.92.2.2-SNAPSHOT');
select "schema".add_foreign_key('schema', 'schema_columns', 'lastVersion',   'schema', 'aoserv_protocols', 'version', '1.92.2.3-SNAPSHOT', null);
