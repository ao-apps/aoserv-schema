select "schema".add_foreign_key('httpd', 'httpd_sites', 'ao_server',               'server',       'ao_servers',          'server',   '1.0a100', null);
...
select "schema".add_foreign_key('httpd', 'httpd_sites', 'php_version',             'distribution', 'technology_versions', 'pkey',     '1.78',    null);
