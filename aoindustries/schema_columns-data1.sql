...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'amount', 8, 'decimal_2', false, false, false, 'the amount of the transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'tax_amount', 9, 'decimal_2', true, false, false, 'the tax amount of the transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'tax_exempt', 10, 'boolean', false, false, false, 'the taxExempt flag for this transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_amount', 11, 'decimal_2', true, false, false, 'the shipping amount for this transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'duty_amount', 12, 'decimal_2', true, false, false, 'the duty amount for this transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_first_name', 13, 'string', true, false, false, 'the shipping first name', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_last_name', 14, 'string', true, false, false, 'the shipping last name', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_company_name', 15, 'string', true, false, false, 'the shipping company name', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_street_address1', 16, 'string', true, false, false, 'the shipping address line 1', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_street_address2', 17, 'string', true, false, false, 'the shipping address line 2', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_city', 18, 'city', true, false, false, 'the shipping city', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_state', 19, 'state', true, false, false, 'the shipping state', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_postal_code', 20, 'zip', true, false, false, 'the shipping postal code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'shipping_country_code', 21, 'country', true, false, false, 'the shipping two-digit ISO 3166-1 alpha-2 country code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'email_customer', 22, 'boolean', false, false, false, 'the flag indicating the API should generate an email to the customer', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'merchant_email', 23, 'email', true, false, false, 'the email address of the merchant', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'invoice_number', 24, 'string', true, false, false, 'the merchant-provided invoice number', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'purchase_order_number', 25, 'string', true, false, false, 'the merchant-provided purchase order number', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'description', 26, 'string', true, false, false, 'the merchant-provided description of this transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_created_by', 27, 'username', false, false, false, 'the business administrator account that provided this credit card', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_principal_name', 28, 'string', true, false, false, 'the application-provided principal who provided this credit card', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_accounting', 29, 'accounting', false, false, false, 'the accounting code of the business that provided this credit card', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_group_name', 30, 'string', true, false, false, 'any application-specific grouping', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_provider_unique_id', 31, 'string', true, false, false, 'the unique ID provided by the merchant services provider storage mechanism', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_masked_card_number', 32, 'string', false, false, false, 'the masked card number', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_first_name', 33, 'string', false, false, false, 'the first name of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_last_name', 34, 'string', false, false, false, 'the last name of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_company_name', 35, 'string', true, false, false, 'the company name for the credit card', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_email', 36, 'email', true, false, false, 'the email address of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_phone', 37, 'phone', true, false, false, 'the phone number of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_fax', 38, 'phone', true, false, false, 'the fax number of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_customer_tax_id', 39, 'string', true, false, false, 'the tax ID of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_street_address1', 40, 'string', false, false, false, 'the street address of the card holder (line 1)', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_street_address2', 41, 'string', true, false, false, 'the street address of the card holder (line 2)', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_city', 42, 'city', false, false, false, 'the city of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_state', 43, 'state', true, false, false, 'the state/province/prefecture of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_postal_code', 44, 'zip', true, false, false, 'the postal code of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_country_code', 45, 'country', false, false, false, 'the two-digit ISO 3166-1 alpha-2 country code of the card holder', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'credit_card_comments', 46, 'string', true, false, false, 'any comments associated with the credit card', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_time', 47, 'time', false, false, false, 'the time the authorization was attempted', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_username', 48, 'username', false, false, false, 'the username of the business_administrator account that processed the transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_principal_name', 49, 'string', true, false, false, 'an application-provided identity of the user who initiated the transaction', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_communication_result', 50, 'string', true, false, false, 'the authorization communication result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_error_code', 51, 'string', true, false, false, 'the provider-specific error code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_error_code', 52, 'string', true, false, false, 'the provider-neutral error code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_error_message', 53, 'string', true, false, false, 'the provider-specific error message', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_unique_id', 54, 'string', true, false, false, 'the per-provider unique ID', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_approval_result', 55, 'string', true, false, false, 'the provider-specific approval result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_approval_result', 56, 'string', true, false, false, 'the provider-neutral approval result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_decline_reason', 57, 'string', true, false, false, 'the provider-specific decline reason', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_decline_reason', 58, 'string', true, false, false, 'the provider-neutral decline reason', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_review_reason', 59, 'string', true, false, false, 'the provider-specific review reason', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_review_reason', 60, 'string', true, false, false, 'the provider-neutral review reason', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_cvv_result', 61, 'string', true, false, false, 'the provider-specific CVV result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_cvv_result', 62, 'string', true, false, false, 'the provider-neutral CVV result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_provider_avs_result', 63, 'string', true, false, false, 'the provider-specific AVS result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_avs_result', 64, 'string', true, false, false, 'the provider-neutral AVS result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'authorization_approval_code', 65, 'string', true, false, false, 'the approval code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_time', 66, 'time', true, false, false, 'the time the capture was attempted', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_username', 67, 'username', true, false, false, 'the username of the business_administrator account that processed the capture', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_principal_name', 68, 'string', true, false, false, 'an application-provided identity of the user who initiated the capture', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_communication_result', 69, 'string', true, false, false, 'the capture communication result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_provider_error_code', 70, 'string', true, false, false, 'the provider-specific error code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_error_code', 71, 'string', true, false, false, 'the provider-neutral error code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_provider_error_message', 72, 'string', true, false, false, 'the provider-specific error message', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'capture_provider_unique_id', 73, 'string', true, false, false, 'the per-provider unique ID', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_time', 74, 'time', true, false, false, 'the time the void was attempted', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_username', 75, 'username', true, false, false, 'the username of the business_administrator account that processed the void', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_principal_name', 76, 'string', true, false, false, 'an application-provided identity of the user who initiated the void', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_communication_result', 77, 'string', true, false, false, 'the void communication result', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_provider_error_code', 78, 'string', true, false, false, 'the provider-specific error code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_error_code', 79, 'string', true, false, false, 'the provider-neutral error code', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_provider_error_message', 80, 'string', true, false, false, 'the provider-specific error message', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'void_provider_unique_id', 81, 'string', true, false, false, 'the per-provider unique ID', '1.29', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'credit_card_transactions', 'status', 82, 'string', false, false, false, 'the status of the transaction', '1.29', null;
commit;
begin;
\echo credit_cards
