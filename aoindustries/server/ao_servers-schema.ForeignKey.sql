select "schema".add_foreign_key('server', 'ao_servers', 'server',              'server', 'servers',        'pkey',   '1.0a100', null);
select "schema".add_foreign_key('server', 'ao_servers', 'daemon_bind',         'net',    'net_binds',      'pkey',   '1.0a100', null);
select "schema".add_foreign_key('server', 'ao_servers', 'failover_server',     'server', 'ao_servers',     'server', '1.0a100', null);
...
select "schema".add_foreign_key('server', 'ao_servers', 'time_zone',           'server', 'time_zones',     'name',   '1.2',     null);
