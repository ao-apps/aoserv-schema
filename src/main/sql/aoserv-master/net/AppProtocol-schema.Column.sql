...
select "schema".add_column('net', 'protocols', 'isUniquePerHost', 'boolean',  false, false, true, 'indicates that the app_protocol is used at most one per host', '1.92.2-SNAPSHOT', null);
