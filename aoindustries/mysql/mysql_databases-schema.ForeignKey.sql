select "schema".add_foreign_key('mysql', 'mysql_databases', 'ao_server',        'server',  'ao_servers',        'server', '1.0a100', '1.3');
select "schema".add_foreign_key('mysql', 'mysql_databases', 'mysql_server',     'mysql',   'mysql_servers',     'pkey',   '1.4',     null);
