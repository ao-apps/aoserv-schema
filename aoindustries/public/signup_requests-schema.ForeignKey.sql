select "schema".add_foreign_key('public', 'signup_requests', 'accounting',           'account', 'businesses',              'accounting', '1.23', '1.43');
...
select "schema".add_foreign_key('public', 'signup_requests', 'encryption_from',      'account', 'encryption_keys',         'pkey',       '1.31', null);
select "schema".add_foreign_key('public', 'signup_requests', 'encryption_key',       'account', 'encryption_keys',         'pkey',       '1.23', '1.30');
select "schema".add_foreign_key('public', 'signup_requests', 'encryption_recipient', 'account', 'encryption_keys',         'pkey',       '1.31', null);
select "schema".add_foreign_key('public', 'signup_requests', 'completed_by',         'account', 'business_administrators', 'username',   '1.23', null);
