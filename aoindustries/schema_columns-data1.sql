...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'distro_files', 'linux_group', 8, 'string', false, false, false, 'the group of the file', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'distro_files', 'linux_group', 9, 'group_id', false, false, false, 'the group of the file', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'dns_zones', 'package', 2, 'package', false, false, false, 'the package that owns the zones', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'dns_zones', 'package', 3, 'accounting', false, false, false, 'the package that owns the zones', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'email_domains', 'package', 4, 'package', false, false, false, 'the owner of the domain', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'email_domains', 'package', 5, 'accounting', false, false, false, 'the owner of the domain', '1.80', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'email_pipes', 'package', 3, 'package', false, false, false, 'the package that this program runs for', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'email_pipes', 'package', 4, 'accounting', false, false, false, 'the package that this program runs for', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'email_smtp_relays', 'package', 1, 'package', false, false, false, 'the package that owns this entry', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'email_smtp_relays', 'package', 2, 'accounting', false, false, false, 'the package that owns this entry', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'package', 4, 'package', false, false, false, 'the package that the site is part of', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'package', 5, 'accounting', false, false, false, 'the package that the site is part of', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'linux_group', 7, 'string', false, false, false, 'the primary group that can edit the site content', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'linux_group', 8, 'group_id', false, false, false, 'the primary group that can edit the site content', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'httpd_sites', 'enable_cgi', 23, 'boolean', false, false, false, 'CGI is enabled on this website', '1.79', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'ip_addresses', 'package',                     6, 'package',    false, false, false, 'the package that the IP address is part of', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'ip_addresses', 'package',                     7, 'accounting', false, false, false, 'the package that the IP address is part of', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_group_accounts', 'group_name', 1, 'string', false, false, false, 'the linux group name', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_group_accounts', 'group_name', 2, 'group_id', false, false, false, 'the linux group name', '1.80', null;
...
begin;
\echo linux_groups
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_groups', 'name', 0, 'string', false, true, false, 'the name of the group', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_groups', 'name', 1, 'group_id', false, true, false, 'the name of the group', '1.80', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_groups', 'package', 2, 'package', false, false, false, 'the package of the group', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_groups', 'package', 3, 'accounting', false, false, false, 'the package of the group', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_server_groups', 'name', 1, 'string', false, false, false, 'the group name', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_server_groups', 'name', 2, 'group_id', false, false, false, 'the group name', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_server_groups', 'gid', 5, 'fkey', false, false, false, 'the gid on that machine', '1.69', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'linux_server_groups', 'gid', 6, 'linux_id', false, false, false, 'the gid on that machine', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'monthly_charges', 'package',     2, 'package',    false, false, false, 'the package that this is charged for',              '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'monthly_charges', 'package',     3, 'accounting', false, false, false, 'the package that this is charged for',              '1.80',    null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_databases', 'name', 1, 'string', false, false, false, 'the name of the database', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_databases', 'name', 2, 'mysql_database_name', false, false, false, 'the name of the database', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_databases', 'package', 5, 'package', false, false, false, 'the package that this database is part of', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_databases', 'package', 6, 'accounting', false, false, false, 'the package that this database is part of', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_server_users', 'username', 1, 'username', false, false, false, 'the username', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_server_users', 'username', 2, 'mysql_username', false, false, false, 'the username', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_servers', 'name', 1, 'string', false, false, false, 'the name of the server', '1.4', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_servers', 'name', 2, 'mysql_server_name', false, false, false, 'the name of the server', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_servers', 'package', 7, 'string', false, false, false, 'the package who owns the instance', '1.28', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_servers', 'package', 8, 'accounting', false, false, false, 'the package who owns the instance', '1.80', null;
commit;
begin;
\echo mysql_users
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_users', 'username', 0, 'username', false, true, false, 'the username of the MySQL user', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'mysql_users', 'username', 1, 'mysql_username', false, true, false, 'the username of the MySQL user', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'net_binds', 'package', 1, 'package', false, false, false, 'the package that owns the opened port', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'net_binds', 'package', 2, 'accounting', false, false, false, 'the package that owns the opened port', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'net_binds', 'port', 7, 'fkey', false, false, false, 'the port number that is bound', '1.69', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'net_binds', 'port', 8, 'net_port', false, false, false, 'the port that is bound', '1.80', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'net_binds', 'net_protocol', 9, 'string', false, false, false, 'the network protocol (<code>net_protocols</code>)', '1.0a100', '1.79';
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'name', 1, 'package', false, true, false, 'the unique name of this package entry', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'packages', 'name', 2, 'accounting', false, true, false, 'the unique name of this package entry', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_databases', 'name', 1, 'string', false, false, false, 'the name of the database', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_databases', 'name', 2, 'postgres_database_name', false, false, false, 'the name of the database', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_servers', 'name', 1, 'string', false, false, false, 'the name of the database', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_servers', 'name', 2, 'postgres_server_name', false, false, false, 'the name of the database', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_server_users', 'username', 1, 'username', false, false, false, 'the username as found in postgres_users', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_server_users', 'username', 2, 'postgres_username', false, false, false, 'the username as found in postgres_users', '1.80', null;
...
begin;
\echo postgres_users
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_users', 'username', 0, 'username', false, true, false, 'the username of the user', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'postgres_users', 'username', 1, 'postgres_username', false, true, false, 'the username of the user', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'ticket_actions', 'old_assigned_to', 15, 'string', true, false, false, '', '1.44', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'ticket_actions', 'old_assigned_to', 16, 'username', true, false, false, '', '1.80', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'ticket_actions', 'new_assigned_to', 17, 'string', true, false, false, '', '1.44', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'ticket_actions', 'new_assigned_to', 18, 'username', true, false, false, '', '1.80', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'usernames', 'package', 1, 'package', false, false, false, 'the package name that this user is part of', '1.0a100', '1.79';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'usernames', 'package', 2, 'accounting', false, false, false, 'the package name that this user is part of', '1.80', null;
