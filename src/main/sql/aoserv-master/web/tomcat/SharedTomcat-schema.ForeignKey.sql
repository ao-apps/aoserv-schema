...
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'ao_server',               'linux',      'ao_servers',            'server',  '1.0a100', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'ao_server',               'linux',      'ao_servers',            'server',  '1.92.2.4-SNAPSHOT', null);
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'version',                 'web.tomcat', 'httpd_tomcat_versions', 'version', '1.0a100', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'version',                 'web.tomcat', 'httpd_tomcat_versions', 'version', '1.92.2.4-SNAPSHOT', null);
...
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'tomcat4_worker',          'web.tomcat', 'httpd_workers',         'bind',    '1.81.18', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'tomcat4_worker',          'web.tomcat', 'httpd_workers',         'bind',    '1.92.2.4-SNAPSHOT', null);
