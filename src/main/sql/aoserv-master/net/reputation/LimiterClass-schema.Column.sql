...
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'class',               'string', false, false, false, 'the reputation class',          '1.66', '1.92.2.1-SNAPSHOT');
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'class',               'enum',   false, false, false, 'the reputation class',          '1.92.2.2-SNAPSHOT', null);
...
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'syn_per_ip_unit',     'string', false, false, false, '',                              '1.66', '1.92.2.1-SNAPSHOT');
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'syn_per_ip_unit',     'enum',   false, false, false, '',                              '1.92.2.2-SNAPSHOT', null);
...
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'syn_unit',            'string', false, false, false, '',                              '1.66', '1.92.2.1-SNAPSHOT');
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'syn_unit',            'enum',   false, false, false, '',                              '1.92.2.2-SNAPSHOT', null);
...
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'packet_per_ip_unit',  'string', false, false, false, '',                              '1.66', '1.92.2.1-SNAPSHOT');
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'packet_per_ip_unit',  'enum',   false, false, false, '',                              '1.92.2.2-SNAPSHOT', null);
...
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'packet_unit',         'string', false, false, false, '',                              '1.66', '1.92.2.1-SNAPSHOT');
select "schema".add_column('net.reputation', 'ip_reputation_limiter_limits', 'packet_unit',         'enum',   false, false, false, '',                              '1.92.2.2-SNAPSHOT', null);
