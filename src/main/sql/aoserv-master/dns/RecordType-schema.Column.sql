...
select "schema".add_column('dns', 'dns_types', 'has_flag',     'boolean', false, false, true, 'flags which types have a flag',                '1.86.0',  null);
select "schema".add_column('dns', 'dns_types', 'has_tag',      'boolean', false, false, true, 'flags which types have a tag',                 '1.86.0',  null);
