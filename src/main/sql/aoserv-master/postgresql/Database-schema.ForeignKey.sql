...
select "schema".add_foreign_key('postgresql', 'postgres_databases', 'postgres_server',  'postgresql', 'postgres_servers',      'bind',  '1.81.18', '1.92.2.3-SNAPSHOT');
select "schema".add_foreign_key('postgresql', 'postgres_databases', 'postgres_server',  'postgresql', 'postgres_servers',      'bind',  '1.92.2.4-SNAPSHOT', null);
