...
create table net_devices (
  ...
  mac_address text check (
    upper(mac_address)!='FF:FF:FF:FF:FF:FF' -- Do not allow broadcast
  ),
  max_bit_rate int8,
  monitoring_bit_rate_low int8 check (monitoring_bit_rate_low is null or monitoring_bit_rate_low>0),
