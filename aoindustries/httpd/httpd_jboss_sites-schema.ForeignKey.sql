select "schema".add_foreign_key('httpd', 'httpd_jboss_sites', 'tomcat_site',            'httpd_tomcat_sites',   'httpd_site', '1.0a100', null);
select "schema".add_foreign_key('httpd', 'httpd_jboss_sites', 'version',                'httpd_jboss_versions', 'version',    '1.0a100', null);
