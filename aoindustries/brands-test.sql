...
insert into brands values(
  ...
  -- Email settings
  (select pkey from linux_server_accounts where ao_server=(select server from ao_servers where hostname='mandriva20060.test.aoindustries.com') and username='aoadmin'), -- smtp_linux_server_account
  'changeme', -- smtp_password
  (select pkey from linux_server_accounts where ao_server=(select server from ao_servers where hostname='mandriva20060.test.aoindustries.com') and username='aoadmin'), -- imap_linux_server_account
