...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'accounting', 1, 'accounting', false, false, false, 'the accounting code of the parent business for the new account', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'time', 2, 'time', false, false, false, 'the time the request was added', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ip_address', 3, 'ip_address', false, false, false, 'the IP address of the user who signed-up', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'package_definition', 4, 'fkey', false, false, false, 'the pkey of the Package Definition requested', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'business_name', 5, 'string', false, false, false, 'the name of the business', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'business_phone', 6, 'string', false, false, false, 'the phone number of the business', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'business_fax', 7, 'string', true, false, false, 'the fax number of the business', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'business_address1', 8, 'string', false, false, false, 'the street address of the business', '1.23', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ba_work_phone', 16, 'string', false, false, false, 'the administrator\'s work phone', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ba_cell_phone', 17, 'string', true, false, false, 'the administrator\'s cell phone', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ba_home_phone', 18, 'string', true, false, false, 'the administrator\'s home phone', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ba_fax', 19, 'string', true, false, false, 'the administrator\'s fax number', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ba_email', 20, 'email', false, false, false, 'the administrator\'s email address', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'ba_address1', 21, 'string', true, false, false, 'the street address of the administrator', '1.23', null;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'billing_email', 29, 'email', false, false, false, 'the email address of the billing contact', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'billing_use_monthly', 30, 'boolean', false, false, false, 'if true, the credit_card will be used every month automatically', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'billing_pay_one_year', 31, 'boolean', false, false, false, 'if true, one-year in advance will be charged to the credit_card and they will receive a credit for a free month', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'encrypted_data', 32, 'string', false, false, false, 'the credit card details and password are stored encrypted', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'encryption_from', 33, 'fkey', false, false, false, 'the from that was used for encryption', '1.31', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'encryption_key', 34, 'fkey', false, false, false, 'the recipient that was used for encryption', '1.23', '1.30';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'encryption_recipient', 35, 'fkey', false, false, false, 'the recipient that was used for encryption', '1.31', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'completed_by', 36, 'username', true, false, false, 'the username of the person who completed this sign-up request', '1.23', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'signup_requests', 'completed_time', 37, 'time', true, false, false, 'the time this request was completed', '1.23', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'primary_minimum_disk_speed', 10, 'int', true, false, false, 'the minimum disk speed in RPM for the primary physical server', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'secondary_minimum_disk_speed', 11, 'int', true, false, false, 'the minimum disk speed in RPM for the secondary physical server', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'extents', 12, 'int', false, false, false, 'the total number of LVM extents for this device', '1.36', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'weight', 13, 'short', false, false, false, 'the amount of primary disk I/O allocated to this virtual device on a scale of 1-1024', '1.41', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'primary_weight', 14, 'short', false, false, false, 'the amount of primary disk I/O allocated to this virtual device on a scale of 1-1024', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'secondary_weight', 15, 'short', false, false, false, 'the amount of secondary disk I/O allocated to this virtual device on a scale of 1-1024', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'primary_physical_volumes_locked', 16, 'boolean', false, false, false, 'indicates this device is locked and should not be moved by automated means', '1.36', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_disks', 'secondary_physical_volumes_locked', 17, 'boolean', false, false, false, 'indicates this device is locked and should not be moved by automated means', '1.36', null;
commit;
begin;
...
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_ram', 2, 'int', true, false, false, 'the amount of RAM required in primary mode in megabytes or 0 if secondary not required', '1.36', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'minimum_processor_type', 3, 'string', true, false, false, 'the minimum processor type', '1.41', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'primary_minimum_processor_type', 4, 'string', true, false, false, 'the minimum processor type in primary mode', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_minimum_processor_type', 5, 'string', true, false, false, 'the minimum processor type in secondary mode', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'minimum_processor_architecture', 6, 'string', false, false, false, 'the minimum processor architecture, compatible architectures may be substituted', '1.36', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'minimum_processor_speed', 7, 'int', true, false, false, 'the minimum processor speed in MHz', '1.41', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'primary_minimum_processor_speed', 8, 'int', true, false, false, 'the minimum processor speed in MHz for primary mode', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_minimum_processor_speed', 9, 'int', true, false, false, 'the minimum processor speed in MHz for secondary mode', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'processor_cores', 10, 'short', false, false, false, 'the number of processor cores', '1.41', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'primary_processor_cores', 11, 'short', false, false, false, 'the number of processor cores used in primary mode', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_processor_cores', 12, 'short', true, false, false, 'the number of processor cores used in secondary mode', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'processor_weight', 13, 'short', false, false, false, 'the processor allocation weight on a scale of 1-1024', '1.41', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'primary_processor_weight', 14, 'short', false, false, false, 'the processor allocation weight in primary mode on a scale of 1-1024', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_processor_weight', 15, 'short', true, false, false, 'the processor allocation weight in secondary mode on a scale of 1-1024', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'primary_physical_server', 16, 'fkey', false, false, false, 'the physical server that provides the primary mode resources', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'primary_physical_server_locked', 17, 'boolean', false, false, false, 'indicates the primary server is locked and should not be moved by automated means', '1.36', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_physical_server', 18, 'fkey', false, false, false, 'the physical server that provides the secondary mode resources', '1.36', '1.40';
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'secondary_physical_server_locked', 19, 'boolean', false, false, false, 'indicates the secondary server is locked and should not be moved by automated means', '1.36', null;
insert into schema_columns select nextval('schema_columns_pkey_seq'), 'virtual_servers', 'requires_hvm', 20, 'boolean', false, false, false, 'indicates requires full hardware virtualization', '1.37', null;
commit;
begin;
\echo whois_history
