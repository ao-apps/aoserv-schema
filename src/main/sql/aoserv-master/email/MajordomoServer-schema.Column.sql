...
select "schema".add_column('email', 'majordomo_servers', 'domain',                 'fkey',   false,  true, false, 'the pkey of the domain that is hosted', '1.0a100', '1.92.2.3-SNAPSHOT');
select "schema".add_column('email', 'majordomo_servers', 'domain',                 'pkey',   false,  true, false, 'the pkey of the domain that is hosted', '1.92.2.4-SNAPSHOT', null);
