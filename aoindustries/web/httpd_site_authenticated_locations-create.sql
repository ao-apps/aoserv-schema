create sequence         web.httpd_site_authenticated_locations_pkey_seq cycle;
grant all            on web.httpd_site_authenticated_locations_pkey_seq to aoadmin;
grant select, update on web.httpd_site_authenticated_locations_pkey_seq to aoserv_app;

create table httpd_site_authenticated_locations (
  pkey integer
    default nextval('web.httpd_site_authenticated_locations_pkey_seq')
    primary key,
  httpd_site integer
    not null,
  "path" text
