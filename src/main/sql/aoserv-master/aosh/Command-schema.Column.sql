...
select "schema".add_column('aosh', 'aosh_commands', 'sinceVersion',  'string', false, false, true, 'the first aoserv_protocol version having this command', '1.81.18', '1.92.2.2-SNAPSHOT');
select "schema".add_column('aosh', 'aosh_commands', 'sinceVersion',  'enum',   false, false, true, 'the first aoserv_protocol version having this command', '1.92.2.3-SNAPSHOT', null);
select "schema".add_column('aosh', 'aosh_commands', 'lastVersion',   'string',  true, false, true, 'the last aoserv_protocol version having this command', '1.81.18', '1.92.2.2-SNAPSHOT');
select "schema".add_column('aosh', 'aosh_commands', 'lastVersion',   'enum',    true, false, true, 'the last aoserv_protocol version having this command', '1.92.2.3-SNAPSHOT', null);
