-- TODO: Index could be automatically generated within the function
...
select "schema".add_column('aoserv_protocols', 'version', 0, 'string', false, true, true, 'the unique version number', '1.0a101', null);
select "schema".add_column('aoserv_protocols', 'created', 1, 'date', false, false, true, 'the time the version was added', '1.0a101', null);
select "schema".add_column('aoserv_protocols', 'comments', 2, 'string', false, false, true, 'any comments about this version', '1.0a101', null);
select "schema".add_column('aoserv_protocols', 'last_used', 3, 'date', true, false, true, 'the date this protocol was last used', '1.9', null);

\echo aosh_commands
select "schema".add_column('aosh_commands', 'command', 0, 'string', false, true, true, 'the unique command', '1.0a100', null);
select "schema".add_column('aosh_commands', 'table_name', 1, 'string', true, false, true, 'the name of the table the column is in, is a global command if the column is null', '1.0a100', null);
select "schema".add_column('aosh_commands', 'short_desc', 2, 'string', false, false, true, 'a short description of the command', '1.0a100', null);
select "schema".add_column('aosh_commands', 'syntax', 3, 'string', false, false, true, 'the syntax of the command', '1.0a100', null);
select "schema".add_column('aosh_commands', 'since_version', 4, 'string', false, false, true, 'the first aoserv_protocol version having this command', '1.0a101', null);
select "schema".add_column('aosh_commands', 'last_version', 5, 'string', true, false, true, 'the last aoserv_protocol version having this command', '1.0a102', null);
...
\echo ip_addresses
select "schema".add_column('ip_addresses', 'pkey',                        0, 'pkey',       false,  true, false, 'a generated, unique key',                                           '1.0a100', null);
select "schema".add_column('ip_addresses', 'ip_address',                  1, 'ip_address', false, false, false, 'the IP address',                                                    '1.0a100', null);
select "schema".add_column('ip_addresses', 'net_device',                  2, 'fkey',        true, false, false, 'the network_device that this IP address is routed through.  May only be null for 0.0.0.0', '1.0a100', null);
select "schema".add_column('ip_addresses', 'is_alias',                    3, 'boolean',    false, false, false, 'indicates that the IP address is using IP aliasing on the network device', '1.0a100', null);
select "schema".add_column('ip_addresses', 'hostname',                    4, 'hostname',   false, false, false, 'the reverse mapping for the hostname',                              '1.0a100', '1.68');
select "schema".add_column('ip_addresses', 'hostname',                    5, 'domain_name', true, false, false, 'the reverse mapping for the hostname, null only allowed for the "0.0.0.0"" or "::" IP addresses', '1.69', null);
select "schema".add_column('ip_addresses', 'package',                     6, 'package',    false, false, false, 'the package that the IP address is part of',                        '1.0a100', '1.80');
select "schema".add_column('ip_addresses', 'package',                     7, 'accounting', false, false, false, 'the package that the IP address is part of',                        '1.80.0',  null);
select "schema".add_column('ip_addresses', 'price',                       8, 'decimal_2',   true, false, false, '',                                                                  '1.0a100', '1.0a122');
select "schema".add_column('ip_addresses', 'created',                     9, 'time',       false, false, false, 'the time the IP address was added',                                 '1.0a100', null);
select "schema".add_column('ip_addresses', 'available',                  10, 'boolean',    false, false, false, 'a flag if the IP address is available',                             '1.0a100', null);
select "schema".add_column('ip_addresses', 'is_overflow',                11, 'boolean',    false, false, false, 'indicates that the IP address is shared by different accounts',     '1.0a100', null);
select "schema".add_column('ip_addresses', 'is_dhcp',                    12, 'boolean',    false, false, false, 'the IP address is obtained via DHCP',                               '1.0a100', null);
select "schema".add_column('ip_addresses', 'ping_monitor_enabled',       13, 'boolean',    false, false, false, 'if ping (ICMP ECHO) is available for monitoring, defaults to true', '1.30',    null);
select "schema".add_column('ip_addresses', 'external_ip_address',        14, 'ip_address',  true, false, false, 'the external IP address, if different than ip_address',             '1.34',    null);
select "schema".add_column('ip_addresses', 'netmask',                    15, 'string',     false, false, false, 'the netmask of the local network',                                  '1.38',    null);
select "schema".add_column('ip_addresses', 'check_blacklists_over_smtp', 16, 'boolean',    false, false, false, 'allows determining some types of blacklists over SMTP protocol',    '1.75',    null);
select "schema".add_column('ip_addresses', 'monitoring_enabled',         17, 'boolean',    false, false, false, 'indicates that this IP address should be monitored',                '1.81.17', null);
...
\echo schema_columns
select "schema".add_column('schema_columns', 'pkey', 0, 'pkey', false, true, true, 'a generated unique pkey', '1.0a100', null);
select "schema".add_column('schema_columns', 'table_name', 1, 'string', false, false, true, 'the name of the table the column is in', '1.0a100', null);
select "schema".add_column('schema_columns', 'column_name', 2, 'string', false, false, true, 'the name of the column', '1.0a100', null);
select "schema".add_column('schema_columns', 'index', 3, 'int', false, false, true, 'the index of the column', '1.0a100', null);
select "schema".add_column('schema_columns', 'type', 4, 'string', false, false, true, 'the type of data in the column', '1.0a100', null);
select "schema".add_column('schema_columns', 'is_nullable', 5, 'boolean', false, false, true, 'if the value may be null', '1.0a100', null);
select "schema".add_column('schema_columns', 'is_unique', 6, 'boolean', false, false, true, 'if true, the value is unique across rows', '1.0a100', null);
select "schema".add_column('schema_columns', 'is_public', 7, 'boolean', false, false, true, 'if the value is publicly accessible', '1.0a100', null);
select "schema".add_column('schema_columns', 'description', 8, 'string', false, false, true, 'any description associated with the column', '1.0a100', null);
select "schema".add_column('schema_columns', 'since_version', 9, 'string', false, false, true, 'the first aoserv_protocol version this column was in', '1.0a101', null);
select "schema".add_column('schema_columns', 'last_version', 10, 'string', true, false, true, 'the last version containing this field', '1.0a104', null);

\echo schema_foreign_keys
select "schema".add_column('schema_foreign_keys', 'pkey', 0, 'pkey', false, true, true, 'a generated unique pkey', '1.0a100', null);
select "schema".add_column('schema_foreign_keys', 'key_column', 1, 'fkey', false, false, true, 'the column that references another column', '1.0a100', null);
select "schema".add_column('schema_foreign_keys', 'foreign_column', 2, 'fkey', false, false, true, 'the referenced column', '1.0a100', null);
select "schema".add_column('schema_foreign_keys', 'is_bridge', 3, 'boolean', false, false, true, 'the foreign key should be used as a dataverse bridge', '1.0a100', '1.30');
select "schema".add_column('schema_foreign_keys', 'tied_bridge', 4, 'fkey', true, false, true, 'the bridge that should be automatically followed', '1.0a100', '1.30');
select "schema".add_column('schema_foreign_keys', 'since_version', 5, 'string', false, false, true, 'the first aoserv_protocol version to have this reference', '1.0a101', null);
select "schema".add_column('schema_foreign_keys', 'last_version', 6, 'string', true, false, true, 'the last aoserv_protocol version to have this references, or null if not yet removed', '1.0a104', null);

\echo schema_tables
select "schema".add_column('schema_tables', 'name', 0, 'string', false, true, true, 'the unique name', '1.0a100', null);
select "schema".add_column('schema_tables', 'table_id', 1, 'pkey', false, true, true, 'a unique ID for the table', '1.0a100', null);
select "schema".add_column('schema_tables', 'display', 2, 'string', false, false, true, 'the display name', '1.0a100', null);
select "schema".add_column('schema_tables', 'is_public', 3, 'boolean', false, false, true, 'if the data contained in the table is accessible to everybody', '1.0a100', null);
select "schema".add_column('schema_tables', 'description', 4, 'string', false, false, true, 'the description of the table', '1.0a100', null);
select "schema".add_column('schema_tables', 'dataverse_editor', 5, 'string', true, false, true, 'the full Java package.Class name of the editor', '1.0a100', '1.30');
select "schema".add_column('schema_tables', 'since_version', 6, 'string', false, false, true, 'the first aoserv_protocol version to have this table', '1.0a101', null);
select "schema".add_column('schema_tables', 'last_version', 7, 'string', true, false, true, 'the last aoserv_protocol version to have this table or null if still used', '1.0a104', null);
select "schema".add_column('schema_tables', 'default_order_by', 8, 'string', true, false, true, 'the default order by clause for client-side sorting', '1.4', '1.30');

\echo schema_types
select "schema".add_column('schema_types', 'type', 0, 'string', false, true, true, 'the unique name', '1.0a100', null);
select "schema".add_column('schema_types', 'num', 1, 'int', false, true, true, 'the unique number', '1.0a100', null);
select "schema".add_column('schema_types', 'since_version', 2, 'string', false, false, true, 'the first aoserv_protocol version this type was in', '1.69', null);
select "schema".add_column('schema_types', 'last_version', 3, 'string', true, false, true, 'the last version containing this type', '1.69', null);
