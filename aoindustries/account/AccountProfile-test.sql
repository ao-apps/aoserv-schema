COPY account."AccountProfile" (pkey, accounting, priority, "name", private, phone, fax, address1, address2, city, "state", country, zip, send_invoice, created, billing_contact, billing_email, technical_contact, technical_email) FROM stdin;
