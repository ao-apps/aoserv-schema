select "schema".add_foreign_key('httpd', 'httpd_site_binds', 'httpd_site',  'httpd',   'httpd_sites',      'pkey',     '1.0a100', null);
select "schema".add_foreign_key('httpd', 'httpd_site_binds', 'httpd_bind',  'httpd',   'httpd_binds',      'net_bind', '1.0a100', null);
