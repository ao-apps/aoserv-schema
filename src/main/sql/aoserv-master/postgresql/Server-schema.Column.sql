...
select "schema".add_column('postgresql', 'postgres_servers', 'bind',                   'fkey',                 false,  true, false, 'the port the server binds to', '1.81.18', '1.92.2.3-SNAPSHOT');
select "schema".add_column('postgresql', 'postgres_servers', 'bind',                   'pkey',                 false,  true, false, 'the port the server binds to', '1.92.2.4-SNAPSHOT', null);
