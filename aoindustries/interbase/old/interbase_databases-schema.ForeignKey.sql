select "schema".add_foreign_key('interbase', 'interbase_databases', 'db_group',                   'interbase_db_groups',    'pkey',  '1.0a100', '1.30');
select "schema".add_foreign_key('interbase', 'interbase_databases', 'datdba',                     'interbase_server_users', 'pkey',  '1.0a100', '1.30');
