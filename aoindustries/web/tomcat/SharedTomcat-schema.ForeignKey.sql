...
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'tomcat4_worker',          'web.tomcat', 'httpd_workers',         'pkey',    '1.0a100', null);
select "schema".add_foreign_key('web.tomcat', 'httpd_shared_tomcats', 'tomcat4_shutdown_port',   'net',        'net_binds',             'pkey',    '1.0a100', null);
