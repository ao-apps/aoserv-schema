select "schema".add_foreign_key('billing', 'package_definitions', 'accounting',                    'public', 'businesses',         'accounting', '1.0a123', '1.43');
select "schema".add_foreign_key('billing', 'package_definitions', 'brand',                         'public', 'brands',             'accounting', '1.44',    '1.44');
select "schema".add_foreign_key('billing', 'package_definitions', 'accounting',                    'public', 'businesses',         'accounting', '1.45',    null);
