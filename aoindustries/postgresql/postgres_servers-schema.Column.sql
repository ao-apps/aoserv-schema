select "schema".add_column('postgresql', 'postgres_servers', 'pkey',                   'pkey',                 false,  true, false, 'a unique, generated primary key', '1.0a100', null);
...
select "schema".add_column('postgresql', 'postgres_servers', 'net_bind',               'fkey',                 false,  true, false, 'the port the server binds to', '1.0a100', null);
