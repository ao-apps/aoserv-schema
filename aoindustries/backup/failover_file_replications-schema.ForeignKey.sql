...
select "schema".add_foreign_key('backup', 'failover_file_replications', 'quota_gid',        'public', 'linux_ids',         'id',     '1.31',    '1.68');
select "schema".add_foreign_key('backup', 'failover_file_replications', 'quota_gid',        'public', 'linux_ids',         'id',     '1.69',    '1.80');
