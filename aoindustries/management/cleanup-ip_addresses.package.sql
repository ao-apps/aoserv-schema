create or replace view
  management."cleanup-ip_addresses.package"
as select
  bu.accounting,
...
revoke all on management."cleanup-ip_addresses.package" from aoadmin;
grant select on management."cleanup-ip_addresses.package" to aoadmin;
