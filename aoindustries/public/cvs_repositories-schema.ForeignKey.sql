select "schema".add_foreign_key('public', 'cvs_repositories', 'linux_server_account', 'linux',  'linux_server_accounts', 'pkey',  '1.0a100', null);
select "schema".add_foreign_key('public', 'cvs_repositories', 'linux_server_group',   'linux',  'linux_server_groups',   'pkey',  '1.0a100', null);
