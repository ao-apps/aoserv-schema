 ...
 * Copyright (C) 2000-2006, 2008, 2009, 2011, 2013, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026  AO Industries, Inc.
...
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3443, 'jdk', '25.0.0', '2026-06-03 11:08:51+00', 'orion', 70);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3444, 'jdk', '25.0.0', '2026-06-03 11:08:51+00', 'orion', 71);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3445, 'jdk', '26.0.0', '2026-06-04 13:30:53.940834+00', 'orion', 70);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3446, 'jdk', '26.0.0', '2026-06-04 13:30:53.940834+00', 'orion', 71);
...
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3439, 'MySQL', '9.7.0', '2026-05-19 15:28:32.865176+00', 'orion', 70);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3440, 'MySQL', '9.7.0', '2026-05-19 15:28:32.865176+00', 'orion', 71);
...
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3435, 'php', '8.3.0', '2026-04-22 16:23:04.68621+00', 'orion', 70);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3436, 'php', '8.3.0', '2026-04-22 16:23:04.68621+00', 'orion', 71);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3441, 'php', '8.4.0', '2026-05-19 20:08:33.85513+00', 'orion', 71);
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3442, 'php', '8.5.0', '2026-05-20 13:13:01.858578+00', 'orion', 71);
...
INSERT INTO distribution."SoftwareVersion" (id, "name", version, updated, owner, operating_system_version) VALUES (
  3434, 'postgresql', '18.0', '2026-04-21 20:32:27.882005+00', 'orion', 71);

COMMIT;

SELECT setval ('distribution."SoftwareVersion_id_seq"', 3447, false);
