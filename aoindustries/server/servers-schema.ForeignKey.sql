...
select "schema".add_foreign_key('server', 'servers', 'architecture',             'public',         'architectures',             'name',       '1.0a100', '1.0a107');
select "schema".add_foreign_key('server', 'servers', 'operating_system_version', 'public',         'operating_system_versions', 'pkey',       '1.0a100', '1.30');
select "schema".add_foreign_key('server', 'servers', 'operating_system_version', 'public',         'operating_system_versions', 'pkey',       '1.31',    null);
