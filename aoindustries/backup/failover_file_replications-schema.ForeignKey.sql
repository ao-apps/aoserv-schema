select "schema".add_foreign_key('backup', 'failover_file_replications', 'from_server',      'server', 'ao_servers',        'server', '1.0a100', '1.30');
select "schema".add_foreign_key('backup', 'failover_file_replications', 'server',           'server', 'servers',           'pkey',   '1.31',    null);
select "schema".add_foreign_key('backup', 'failover_file_replications', 'to_server',        'server', 'ao_servers',        'server', '1.0a100', '1.30');
