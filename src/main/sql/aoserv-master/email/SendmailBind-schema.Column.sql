...
select "schema".add_column('email', 'sendmail_binds', 'net_bind',        'fkey',   false,  true, false, 'the IP address, port, and protocol details',   '1.81.10', '1.92.2.3-SNAPSHOT');
select "schema".add_column('email', 'sendmail_binds', 'net_bind',        'pkey',   false,  true, false, 'the IP address, port, and protocol details',   '1.92.2.4-SNAPSHOT', null);
