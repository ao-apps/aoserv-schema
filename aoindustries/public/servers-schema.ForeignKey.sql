...
select "schema".add_foreign_key('public', 'servers', 'owner',                    'account',        'businesses',                'accounting', '1.0a100', '1.30');
select "schema".add_foreign_key('public', 'servers', 'administrator',            'account',        'business_administrators',   'username',   '1.0a100', '1.30');
